...
```{r}
pairs(~rating+year+budget+votes,data=movies[movies$year>1980,])
...
```{r}
library(wordcloud)
wordcloud(substr(movies$title[movies$year>1980],1,30),movies$rating[movies$year>1980]^2*movies$votes[movies$year>1980],max.words = 100,colors = brewer.pal(8,"Dark2"),scale=c(2,0),random.order = F)
